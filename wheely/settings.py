...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': int(os.environ.get('PAGINATION_PAGE_SIZE', '20')),
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.environ.get('LOG_FILE_PATH', 'logs/django.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
ALLOWED_DOCUMENT_TYPES = os.environ.get('ALLOWED_DOCUMENT_TYPES', 'pdf,doc,docx').split(',')
